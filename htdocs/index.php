...
<p>Filter icons will appear in columns which support filtering. Click the "set filter" icon <img src="images/filter_on.jpg">  next to the value you wish to select for that column. To undo filtering, click the "remove filter" icon <img src="images/filter_rm.jpg">. </p>
...
<tr><td><img src="images/index_card.jpg"></td><td>This icon indicates a link to another site on the AT&T intranet which contains more comprehensive information regarding the item it appears next to.</td></tr>
